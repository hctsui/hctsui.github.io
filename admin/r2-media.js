...
/* Read deployment status through the authenticated Worker instead of GitHub's anonymous browser API. */
(function installWorkerDeploymentPolling(){
  ...
  function startWorkerDeploymentPolling(){
    if(typeof stopDeploymentPolling==='function')stopDeploymentPolling();
  ...
  document.addEventListener('visibilitychange',()=>{
    const panel=document.querySelector('[data-notification-panel]');
    if(document.hidden){if(typeof stopDeploymentPolling==='function')stopDeploymentPolling();return;}
