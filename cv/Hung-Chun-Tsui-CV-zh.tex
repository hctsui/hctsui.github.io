...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{崔鴻竣}
{(4)} \textbf{正特徵的 $u$-多重 $\zeta$ 值}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/papers/2026-on-u-multiple-zeta-values-in-positive-characteristic.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2604.03618}{arXiv}]}\\\textit{arXiv: 2604.03618}, 2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{學術訪問}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
