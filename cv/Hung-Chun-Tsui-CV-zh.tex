...
{(1)} \textbf{正特徵上的多重 Eisenstein 級數：直和定理}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/papers/2026-on-multiple-eisenstein-series-in-positive-characteristic-direct-sum-result.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2609.18777}{arXiv}]}\\\textit{arXiv: 2609.18777}, 2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{崔鴻竣}
{(2)} \textbf{$\infty$-進多重 $\zeta$ 值餘作用的 Mishiba 猜想}\\2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{崔鴻竣}
