...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2025 秋}
\textit{助教}\quad MATH2410 代數（一）
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2026 春}
\textit{助教}\quad MATH2420 代數（二）
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2026 春}
\textit{助教}\quad MATH2870 離散數學
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2025 秋}
\textit{助教}\quad MATH3450 密碼學
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2024 秋}
\textit{助教}\quad MATH1410 線性代數（一）
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2025 春}
\textit{助教}\quad MATH1420 線性代數（二）
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2025 春}
\textit{助教}\quad MATH3050 複變數函數論
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2023 秋}
\textit{助教}\quad MATH2010 高等微積分（一）
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2024 春}
\textit{助教}\quad MATH2020 高等微積分（二）
\end{conf}
% CMS:TEACHING:END
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{個人資訊}
