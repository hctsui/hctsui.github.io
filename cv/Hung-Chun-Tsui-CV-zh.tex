...
\cvgroup{預印本}
\begin{pub}{崔鴻竣}
{(1)} \textbf{$\infty$-進多重 $\zeta$ 值餘作用的 Mishiba 猜想}\\2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{張介玉, 陳松筠, 黃斐浚, 崔鴻竣}
{(2)} \textbf{正特徵上的多重 Eisenstein 級數：直和定理}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/papers/2026-on-multiple-eisenstein-series-in-positive-characteristic-direct-sum-result.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2609.18777}{arXiv}]}\\\textit{arXiv: 2609.18777}, 2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{崔鴻竣}
{(3)} \textbf{正特徵的 $u$-多重 $\zeta$ 值}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/papers/2026-on-u-multiple-zeta-values-in-positive-characteristic.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2604.03618}{arXiv}]}\\\textit{arXiv: 2604.03618}, 2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{張庭瑋, 陳松筠, 黃斐浚, 崔鴻竣}
{(4)} \textbf{正特徵多重 Eisenstein 級數的代數結構}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/papers/2026-algebra-structures-of-multiple-eisenstein-series-in-positive-characteristic.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2603.10376}{arXiv}]}\\\textit{arXiv: 2603.10376}, 2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{張庭瑋, 陳松筠, 黃斐浚, 崔鴻竣}
{(5)} \textbf{正特徵任意秩多重 Eisenstein 級數的 $q$-洗牌關係}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/papers/2025-on-q-shuffle-relations-for-multiple-eisenstein-series-of-arbitrary-rank-in-positive-characteristic.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2504.18879}{arXiv}]}\\\textit{arXiv: 2504.18879}, 2025.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{張庭瑋, 崔鴻竣}
{(6)} \textbf{函數體上 Gross--Koblitz 型公式中 $v$-進 $\Gamma$ 函數的唯一性}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/papers/2025-uniqueness-of-v-adic-gamma-functions-in-gross-koblitz-type-formulas-over-function-fields.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2504.15697}{arXiv}]}\\\textit{arXiv: 2504.15697}, 2025.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{學術訪問}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2026/7/2 -- 2026/8/30}
\textbf{東北大學}\\仙台, 日本 · 本次訪問經費由公益財團法人日本台灣交流協會提供
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{學術報告}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2026/7/6}
\textbf{正特徵多重 Eisenstein 級數的近期發展}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/slides/2026-7-6-tohuku-university-number-theory-seminar.pdf}{投影片}]}\\東北大學數論研討會, 東北大學, 仙台, 日本
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2026/2/8}
\textbf{函數體上的有限多重調和 $u$-級數}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/slides/2026-2-8-nagoya-kansai-zeta-workshop-for-young-researchers.pdf}{投影片}]}\\名古屋---關西青年研究者 $\zeta$ 研討會, 名古屋大學, 名古屋, 日本
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2025/9/3}
\textbf{正特徵多重 Eisenstein 級數的 $q$-洗牌關係}\\{\small\color{secondaryColor}[\hrefWithoutArrow{https://hctsui-website-worker.hctsui-math.workers.dev/media/slides/2025-9-3-japan-taiwan-number-theory-conference.pdf}{投影片}]}\\日臺數論會議, 休暇村志賀島, 福岡, 日本
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hrefWithoutArrow{https://edu.tsuda.ac.jp/~t-hara/ss2026/index.html}{\textbf{第 33 屆數論暑期學校：函數體的算術}}\\矢太樓, 長崎, 日本
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hrefWithoutArrow{https://sites.google.com/view/workshoponarithmeticoffunction/home}{\textbf{函數體算術工作坊}} \quad {\color{secondaryColor}（講者）}\\國立成功大學, 臺南, 臺灣
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2026/2/8 -- 2026/2/11}
\hrefWithoutArrow{https://sites.google.com/view/zetayoung19?authuser=0}{\textbf{名古屋---關西青年研究者 $\zeta$ 研討會}} \quad {\color{secondaryColor}（講者）}\\名古屋大學, 名古屋, 日本
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hrefWithoutArrow{https://sites.google.com/view/rimsmzv2025/home}{\textbf{多重 $\zeta$ 值的各種面向}} \quad {\color{secondaryColor}（講者）}\\京都大學, 京都, 日本
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2025/9/1 -- 2025/9/5}
\hrefWithoutArrow{https://www.cck.dendai.ac.jp/math/~namikawa/2025JapanTaiwan/2025JapanTaiwan.html}{\textbf{日臺數論會議}} \quad {\color{secondaryColor}（講者）}\\休暇村志賀島, 福岡, 日本
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{conf}{2025/4/17}
\hrefWithoutArrow{https://www.math.nthu.edu.tw/download.php?dir=seminar_event\&filename=19eeb11766f7313f8b3696d3069dd8e7.pdf\&title=2025.04.17}{\textbf{國立清華大學數論研討會}}\\國立清華大學, 新竹, 臺灣
\end{conf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cvgroup{國立清華大學}
\begin{teaching}{MATH5410 近世代數（一）}{2026 秋}
    助教
\end{teaching}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{teaching}{MATH5640 代數幾何}{2026 秋}
    助教
\end{teaching}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{teaching}{MATH1000 微積分預備課程}{2026 秋}
    助教
\end{teaching}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
