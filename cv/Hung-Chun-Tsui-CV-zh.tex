...
\cvgroup{預印本}
\begin{pub}{張庭瑋, 崔鴻竣}
{(1)} \textbf{函數體上 Gross--Koblitz 型公式中 $v$-進 $\Gamma$ 函數的唯一性}\\{\small\color{secondaryColor}[\hrefWithoutArrow{/files/papers/2025-uniqueness-of-v-adic-gamma-functions-in-gross-koblitz-type-formulas-over-function-fields.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2504.15697}{arXiv}]}\\\textit{arXiv: 2504.15697}, 2025.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{張庭瑋, 陳松筠, 黃斐浚, 崔鴻竣}
{(2)} \textbf{正特徵任意秩多重 Eisenstein 級數的 $q$-洗牌關係}\\{\small\color{secondaryColor}[\hrefWithoutArrow{/files/papers/2025-on-q-shuffle-relations-for-multiple-eisenstein-series-of-arbitrary-rank-in-positive-characteristic.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2504.18879}{arXiv}]}\\\textit{arXiv: 2504.18879}, 2025.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{張庭瑋, 陳松筠, 黃斐浚, 崔鴻竣}
{(3)} \textbf{正特徵多重 Eisenstein 級數的代數結構}\\{\small\color{secondaryColor}[\hrefWithoutArrow{/files/papers/2026-algebra-structures-of-multiple-eisenstein-series-in-positive-characteristic.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2603.10376}{arXiv}]}\\\textit{arXiv: 2603.10376}, 2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{pub}{崔鴻竣}
{(4)} \textbf{正特徵的 $u$-多重 $\zeta$ 值}\\{\small\color{secondaryColor}[\hrefWithoutArrow{/files/papers/2026-on-u-multiple-zeta-values-in-positive-characteristic.pdf}{PDF} | \hrefWithoutArrow{https://arxiv.org/abs/2604.03618}{arXiv}]}\\\textit{arXiv: 2604.03618}, 2026.
\end{pub}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{學術報告}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
