...
<html lang="{"zh-Hant" if zh else "en"}"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="author" content="Hung-Chun Tsui"><title>{esc(page_seo["title"])}</title>
